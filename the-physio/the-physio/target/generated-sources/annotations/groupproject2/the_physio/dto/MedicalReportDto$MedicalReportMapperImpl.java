...
import groupproject2.the_physio.dto.MedicalReportDto.MedicalReportMapper;
import groupproject2.the_physio.dto.MedicalReportDto.MedicalReportRequest;
import groupproject2.the_physio.dto.MedicalReportDto.MedicalReportResponse;
...
public class MedicalReportDto$MedicalReportMapperImpl implements MedicalReportMapper {

    @Override
    public MedicalReport fromRequestToEntity(MedicalReportRequest medicalReportRequest) {
    ...
    @Override
    public MedicalReportResponse fromEntityToResponse(MedicalReport medicalReportEntity) {
        if ( medicalReportEntity == null ) {
            return null;
        }

        MedicalReportResponse medicalReportResponse = new MedicalReportResponse();
