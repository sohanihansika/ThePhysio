  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={setIsOpen}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-[50%] left-[60%] translate-x-[-60%] translate-y-[-50%] w-full max-w-lg mx-auto px-4"> {/* Moved to the right */}
          <div className="bg-white rounded-md shadow-lg px-4 py-6">
            ...
            <Dialog.Description className="mt-1 text-sm leading-relaxed text-center text-gray-500">
              Your appointment has been successfully scheduled. Click "OK" to return to your dashboard.
            </Dialog.Description>
