...
const Card1 = () => {
  return (
    <section className="py-6 dark:bg-gray-100 dark:text-gray-900">
      <div className="container mx-auto flex flex-col items-center justify-center max-w-lg p-4 lg:max-w-full sm:p-10 lg:flex-row bg-[#d24e01]">
        <div className="flex flex-col items-center justify-center flex-1 p-4 pb-8 sm:p-8 lg:p-16 bg-gray-500">
          <p className="text-5xl font-bold text-center">Membership</p>
        ...
        <div className="flex flex-col items-center justify-center flex-1 p-4 pb-8 text-center rounded-md sm:p-8 lg:p-16 bg-gray-400 dark:text-gray-50">
          <p className="text-5xl font-bold">Subscrpitions</p>
