    ...
    <div className="p-16">
      <div className="p-8 bg-white shadow mt-24">
        <div className="grid grid-cols-1 md:grid-cols-3">
          ...
          <div className="relative">
            <div className="w-48 h-48 bg-indigo-100 mx-auto rounded-full shadow-2xl absolute inset-x-0 top-0 -mt-24 flex items-center justify-center text-indigo-500">
              <img src="./src/assets/GymPlans/coach1.jpg" alt="Mandy" className="w-24 h-24 rounded-full object-cover" />
            </div>
          </div>
        ...
        <div className="mt-20 text-center border-b pb-12">
          <h1 className="text-4xl font-medium text-gray-700">Coach Mandy Perera, <span className="font-light text-gray-500">Senior Gym Coach</span></h1>
          <p className="font-light text-gray-600 mt-3">With over 10 years of experience, Mandy specializes in gym training.</p>
          <p className="mt-8 text-gray-500">Contact: mandy1@example.com</p>
