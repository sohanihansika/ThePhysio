...
const Appointments = () => {
  ...
  const [tableItems, setTableItems] = useState([
    { time: "9.00 - 9.30", name: "Bob", session: "Suspension", room: "1" },
    { time: "9.00 - 9.30", name: "Christine", session: "Cardio", room: "2" },
    { time: "9.00 - 9.30", name: "Charlotte", session: "HIIT", room: "4" },
  ]);
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4 md:px-8 mt-6">
      ...
      <div className="mt-7 flex justify-end">
        <a href="/coachAppointment" className="py-2 px-4 bg-[#051B40] text-white rounded-md">
          Back
        </a>
      </div>
    </div>
