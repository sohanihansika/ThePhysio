            ...
            <ul className="flex justify-center mb-3">
              <li className="flex-1">
                <a href="#" className="block text-center py-2 px-4 rounded bg-blue-500 text-white font-semibold">
                  <i className="fab fa-credit-card mr-2"></i> Payment
                </a>
              </li>
            </ul>
          </div>
            ...
            <form onSubmit={handlePayment}>
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  <input
                    ...
                    maxLength="19" // For card number length
                  />
              ...
              <div className="mb-4">
                ...
                <div className="flex space-x-2">
                  ...
                  <input
                    ...
                    className="mt-1 block w-1/2 p-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    required
                    min="22" // Example for current year
                    value={expiryYear}
              ...
              <div className="mb-4">
                <label htmlFor="cvv" className="block text-sm font-medium text-blue-600">
                  CVV
                  <span className="ml-1 text-gray-400" data-tooltip="Three digit CV code on the back of your card">?</span>
                </label>
                <input
                  type="text"
                  id="cvv"
                  ...
                  maxLength="4" // CVV length
                />
              </div>
              <div className="mt-6">
                <button
                  type="submit"
                  className="w-full bg-blue-600 text-white py-3 rounded-md shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 text-lg font-semibold"
                >
                  Confirm Payment
                </button>
              </div>
