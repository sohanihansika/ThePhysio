        ...
        <div className="auth-container">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                    ...
                    <input type="text" name="contactNo" value={formData.contactNo} onChange={handleInputChange} placeholder="Enter your contactNo" required />
                </div>
                <div className="form-group">
                    <label>AddedDate:</label>
                    <input type="text" name="addedDate" value={formData.addedDate} onChange={handleInputChange} placeholder="Enter your addedDate" required />
                </div>
